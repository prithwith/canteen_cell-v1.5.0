// ignore_for_file: prefer_const_constructors, prefer_interpolation_to_compose_strings, unnecessary_string_interpolations, camel_case_types, prefer_collection_literals, use_build_context_synchronously, deprecated_member_use, avoid_single_cascade_in_expression_statements
...
import 'package:canteen_cell/pages/Studentlistsearch.dart';
                  ...
                  IconButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Studentlistsearch(),
                        ),
                      ).whenComplete(
                        () => _refreshData(),
                      );
                        ...
                        ListTile(
                          ...
                          title: Column(
                            ...
                            children: [
                              ...
                              AutoSizeText('${signuplist[index].batch}'),
                            ],
                          ),
                          subtitle: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
