// ignore_for_file: prefer_const_constructors, prefer_interpolation_to_compose_strings, unnecessary_string_interpolations, deprecated_member_use, use_build_context_synchronously, file_names, prefer_final_fields, avoid_single_cascade_in_expression_statements
...
class Studentlistsearch extends StatefulWidget {
  const Studentlistsearch({super.key});

  @override
  State<Studentlistsearch> createState() => _StudentlistsearchState();
}

class _StudentlistsearchState extends State<Studentlistsearch> {
