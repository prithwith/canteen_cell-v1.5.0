// ignore_for_file: use_key_in_widget_constructors, no_logic_in_create_state, use_build_context_synchronously, avoid_single_cascade_in_expression_statements, prefer_const_constructors, deprecated_member_use, prefer_interpolation_to_compose_strings, non_constant_identifier_names, prefer_const_literals_to_create_immutables
...
class Multipleorder extends StatefulWidget {
  // const Multipleorder({super.key});
  User user;
  String timechange;
  List<String> orderdatelist, holidayist;
  Multipleorder(
      this.user, this.orderdatelist, this.holidayist, this.timechange);

  @override
  State<Multipleorder> createState() =>
      _MultipleorderState(user, orderdatelist, holidayist, timechange);
}

class _MultipleorderState extends State<Multipleorder> {
  User user;
                                                        ...
                                                        onPressed: () {
                                                          ...
                                                          ordermultiplemill(
                                                            ...
                                                            "-" +
                                                                Showtotalbalance
                                                                    .toString(),
                                                            "Meal Ordered For $formattedDates Dates",
                                                          );
                                                        },
                                                        child: Text(
                                                          'Confirm'
